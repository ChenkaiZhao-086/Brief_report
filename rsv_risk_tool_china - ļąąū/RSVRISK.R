...
hos <- read.csv("D:/学习相关/RSV risk pred/02. 数据代码/RSV risk/summaryData_hosORs.csv")
poc <- read.csv("D:/学习相关/RSV risk pred/02. 数据代码/RSV risk/summaryData_hosPoorORs.csv")
HosProb <- read.csv("D:/学习相关/RSV risk pred/02. 数据代码/RSV risk/summaryData_hosProp.csv")
RiskPercent <- read.csv("D:/学习相关/RSV risk pred/02. 数据代码/RSV risk/summaryData_forHospRiskClass.csv") 
